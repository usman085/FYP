...
const AppointmentTable = () => {
        ...
        return (
                ...
                div className = "row" > {
                    ...
                    contextData_2.allAppointments.map(SingleAp => < AppointmentCard data = { SingleAp }
                    ...
                    style = {
                            ...
                            p className = "text-center text-secondary  small mb-5" > On { contextData.date.toLocaleString('default', { month: 'long' }) } { contextData.date.getDate() },
                            { contextData.date.getFullYear() } < /p> <
                            ...
                            className = "form-control" / > {
                                ...
                                className = "form-control" / > {
                                    ...
                                    className = "form-control" / > {
                                        ...
                                        value = "Not set" > Select Gender < /option> <
